...
export class ApiStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    this.albSecurityGroup.addIngressRule(
      ec2.Peer.anyIpv4(),
      ec2.Port.tcp(80),
      'Public ALB ingress — the only 0.0.0.0/0 rule in this stack, and the only one anywhere in the v2 backend (by design: only the ALB is internet-facing, DEPLOYMENT.md §9).',
    );
