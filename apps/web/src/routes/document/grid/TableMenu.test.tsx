...
describe('TableMenu (A11Y-01, MENU-02)', () => {
  it('DOC-02 MENU-02 with a table selected, cell commands are disabled with the reason; the menu carries only the commands whose home it is — no Add row, header, footer, frozen or wrap (#140, ADR 39)', async () => {
