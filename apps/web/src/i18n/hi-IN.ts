...
export const messages: Messages = {
  ...
  'tour.step3.note':
    'Numbers: UNIQUE अपना परिणाम एक स्तंभ में नीचे फैला देता है। GeDe: सेल के अल्पविराम एक सेट बनाते हैं, और सेट सूत्र का परिणाम एक ही सेल है जो अपने स्रोतों की तरह पढ़ा जाता है।',
  ...
  'tour.step3.result.action': 'दो तर्कों वाला एक Diff, Inter, Comp या Cross कमिट करें',
