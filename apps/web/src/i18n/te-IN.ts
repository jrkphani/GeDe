...
export const messages: Messages = {
  ...
  'tour.step3.note':
    'Numbers: UNIQUE తన ఫలితాన్ని ఒక నిలువు వరుసలో కిందికి పరుస్తుంది. GeDe: సెల్‌లోని కామాలు ఒక సెట్‌ను చేస్తాయి, సెట్ సూత్రం ఫలితం తన మూలాల్లాగే చదివే ఒకే సెల్.',
  ...
  'tour.step3.result.action':
    'రెండు ఆర్గ్యుమెంట్‌లతో ఒక Diff, Inter, Comp లేదా Cross ను కమిట్ చేయండి',
