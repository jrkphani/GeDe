...
export const messages: Messages = {
  ...
  'tour.step3.point.title': 'దాన్ని ఒక పట్టికవైపు చూపండి',
  ...
  'tour.step3.point.offCanvas': 'ఒక పట్టిక canvas బయట ఉంది; తెరపై ఉన్నది సరిపోతుంది.',
  'tour.step3.point.action': 'graph ను బంధించడానికి ఒక పట్టికను క్లిక్ చేయండి',

  'tour.step3.dimensions.title': 'కొలతలను ఎంచుకోండి',
  'tour.step3.dimensions.body':
    'కొలత అంటే విలువలు ఒక సందర్భాన్ని నిర్వచించే నిలువు వరుస; కాబట్టి విలువల ప్రతి కలయిక ఒక node. graph మొదట నమోదు చేసిన మూడు నిలువు వరుసలతో మొదలవుతుంది; Graph ట్యాబ్ ప్రతి నిలువు వరుసను దాని విభిన్న విలువలతో జాబితా చేస్తుంది.',
  'tour.step3.dimensions.action': 'Graph ట్యాబ్‌లో కనీసం రెండు కొలతలను టిక్ చేయండి',
  ...
  'tour.step5.note': 'iCloud షేరింగ్ లాగే, ప్రతి వ్యక్తికి మీరు సెట్ చేసే ఒక అనుమతితో.',
