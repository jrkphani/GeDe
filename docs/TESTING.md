...
| `formulas.spec.ts`   | FX-02 FX-06 FX-07 FX-08 A11Y-04 a `=Sum(B5:B6)` shows its value, `ƒ1` badge and (in a wrapped row) the expression; editing an operand updates it; text in range is an error with icon and text; selecting the cell outlines the range as one indexed block at 100 % and 122 % and clears on Escape; axe on the document · FX-06 a reference loop reports `circular` on every member                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
