...
## ADR-028 Archive and trash are document states; deletability follows access, not history

**Status:** accepted — LIB-D1..D11 (`wave3/library-states`). Numbered past the two ADR-026 entries landing in parallel (sort #74, references #77); the integrator may renumber.
