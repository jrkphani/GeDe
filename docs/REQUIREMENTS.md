...
- **AUTH-06** — Code step: Six digits, numeric input mode, autocomplete `one-time-code`. Non-digits are stripped. Verify is disabled below six digits. State the 10-minute expiry and offer Resend.
