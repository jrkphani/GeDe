...
- **Surface**: dimension manager lives in a popover from the canvas header (0 radius, the app's single shadow token) — a compact list, not a settings page.
...
**References**: SPEC §1 (dimensionality), §3 (dimensions) · STYLE_GUIDE §2.3 (palette), §4 (popover shadow) · ADR-0002
