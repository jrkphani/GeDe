...
- **Status**: OPEN — user-reported UX friction (2026-07-21), **written from an adversarial UX debate** (proponent vs. skeptic, both grounded in the code). Not yet scoped for build — see Open Questions; a few of them are genuine forks for the owner.
